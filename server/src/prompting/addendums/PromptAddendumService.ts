...
const PROMPT_ADDENDUM_DESCRIPTIONS: Record<string, string> = {
  ...
  "novel.chapter_editor.ai_writing_detect": "检测章节正文里像 AI / 模板的写法，并给出修改建议。",
  "novel.chapter_editor.image_story_pack": "把单章正文拆成竖屏切图镜头序列，供外部出图模型按剧情顺序生成图片。",
  "novel.chapter_editor.style_benchmark_essence": "从范文提炼可迁移的声口、对话、节奏等精髓要点，供仿写对照。",
  "novel.chapter_editor.style_benchmark_rewrite": "按学习范本精髓重写本章，生成仅供对照学习的范本稿。",
  "novel.chapter_editor.style_benchmark_segment_rewrite": "对长章分段按范文精髓仿写，保持情节与邻段衔接。",
  "novel.chapter_editor.style_benchmark_unify": "把分段仿写结果拼回整章并统一声口与节奏。",
  "novel.chapter_editor.style_benchmark_compare": "按情节节拍对齐用户稿与范本稿，逐段比较并给出可执行改进。",
...
const PROMPT_CATALOG_SHORT_DESCRIPTIONS: Record<string, string> = {
  ...
  "comic.episodeOutline.faithful": "漫画保真分话大纲",
  "comic.panelScript": "漫画分镜脚本",
  "comic.panelScript.faithful": "漫画保真分镜脚本",
  "comic.fidelityCheck": "漫画原文保真校验",
  "comic.visualAnchorRewrite": "漫画外貌锚点重写",
  "adaptation.source.text_bundle": "文本导入改编素材",
  "adaptation.source.original_bundle": "原创改编素材",
  ...
  "novel.chapter_editor.ai_writing_detect": "AI写法检测",
  "novel.chapter_editor.image_story_pack": "本章切图提示词",
  "novel.chapter_editor.style_benchmark_essence": "范本精髓抽取",
  "novel.chapter_editor.style_benchmark_rewrite": "范本对照仿写",
  "novel.chapter_editor.style_benchmark_segment_rewrite": "范本分段仿写",
  "novel.chapter_editor.style_benchmark_unify": "范本仿写统一",
  "novel.chapter_editor.style_benchmark_compare": "范本对照点评",
