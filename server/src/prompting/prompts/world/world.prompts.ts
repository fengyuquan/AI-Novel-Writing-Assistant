...
> = {
  ...
  render: (input) => [
    new SystemMessage([
      ...
      "",
      "内容数量要求：",
      input.openingOnly ? "1. rules.axioms 生成 2-3 条开篇硬规则。" : "1. rules.axioms 生成 3-5 条。",
      input.openingOnly ? "2. factions 生成 1-2 个开篇直接相关的阵营。" : "2. factions 生成 2-4 个抽象阵营或立场板块。",
      input.openingOnly ? "3. forces 生成 2-3 个开篇会行动或施压的具体势力。" : "3. forces 生成 3-6 个具体势力、组织、机构或行动主体。",
      input.openingOnly ? "4. locations 生成 2-3 个前 3-5 章会直接使用的舞台地点。" : "4. locations 生成 3-6 个会在本书中反复使用的舞台地点。",
