...
test("prompt registry exposes versioned planning assets", () => {
  const keys = [
    ...
    "novel.volume.outline_import@v2",
    "novel.volume.outline_import_conflict@v1",
    "novel.create.from_outline_bootstrap@v2",
    "title.generation@v1",
...
test("novel main-chain prompt assets declare explicit non-zero context budgets", () => {
  const expectedBudgets = new Map([
    ...
    ["novel.volume.outline_import@v2", NOVEL_PROMPT_BUDGETS.volumeOutlineImport],
    ["novel.volume.outline_import_conflict@v1", NOVEL_PROMPT_BUDGETS.volumeOutlineImportConflict],
    ["novel.create.from_outline_bootstrap@v2", NOVEL_PROMPT_BUDGETS.createFromOutlineBootstrap],
