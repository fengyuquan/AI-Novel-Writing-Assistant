...
export const AUTO_DIRECTOR_MOBILE_CLASSES = {
  ...
  followUpFilterGrid: "auto-director-follow-up-filter-grid grid min-w-0 grid-cols-1 gap-2 sm:grid-cols-2 xl:grid-cols-3",
  ...
  stageStickyActionBar:
    "sticky bottom-0 z-20 -mx-1 mt-3 border-t border-border/60 bg-background/95 px-1 py-3 backdrop-blur pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:static sm:mx-0 sm:mt-2 sm:border-0 sm:bg-transparent sm:p-0 sm:pt-2 sm:backdrop-blur-none",
  stageActionRow: "flex flex-col gap-2 sm:flex-row sm:justify-between",
