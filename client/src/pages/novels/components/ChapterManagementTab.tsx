...
import MobileChapterExecutionShell from "../mobile/MobileChapterExecutionShell";

export default function ChapterManagementTab(props: ChapterTabViewProps) {
  const isMobileViewport = useIsMobileViewport();
  if (isMobileViewport) {
    return <MobileChapterExecutionShell {...props} />;
  }

  return <DesktopChapterManagementTab {...props} />;
}

function DesktopChapterManagementTab(props: ChapterTabViewProps) {
  const {
    novelId,
